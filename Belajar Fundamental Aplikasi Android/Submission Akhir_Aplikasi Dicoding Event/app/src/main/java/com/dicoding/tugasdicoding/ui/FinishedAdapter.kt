...
class FinishedAdapter(private val events: List<ListEventsItem>) : RecyclerView.Adapter<FinishedAdapter.EventViewHolder>() {
    ...
    override fun onBindViewHolder(holder: EventViewHolder, position: Int) {
        ...
        holder.root.setOnClickListener {
            ...
            val intent = Intent(context, DetailActivity::class.java).apply {
                putExtra(DetailActivity.EXTRA_EVENT_ID, event.id.toString()) // Ensure event ID is a string
            }
